...
import Logica.AdministradorProxy;
import Logica.Dados;
...
public class JanelaAdministrador implements JanelaInterface{
	...
	private JLabel nome, senha, cpf;
	private JTextField entradaNome, entradaCpf;
		...
		botao1.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				    if(usuarios.usuarioExiste(entradaNome.getText())){
				    	...
				    	try{
				    		usuarios.addUsuario(entradaNome.getText(), new AdministradorProxy(entradaNome.getText(),
